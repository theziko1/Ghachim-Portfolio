              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-xs md:text-sm italic">
                   Developed WordPress websites, resolved technical issues, automated CRM marketing, integrated communication channels, and aligned development with business goals.{" "}
                  </div>
                  {/* JOB DATE */}
